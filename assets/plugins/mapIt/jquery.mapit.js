...
document.write('<scr'+'ipt type="text/javascript" src="https://maps.googleapis.com/maps/api/js?sensor=false&key=AIzaSyA8yA2dgLc-O9d7Q0rMzQkRN9saHna7C_Y" ></scr'+'ipt>');

;(function($, window, undefined) {
	"use strict";

	$.fn.mapit = function(options) {
// address: '-27.219969858168373, -49.643057999999996' 
		var defaults = {
			latitude: 	 -27.219969858168373,
			longitude: 	 -49.643057999999996,
			zoom: 			 16,
			type: 			 'ROADMAP',
			scrollwheel: false,
			marker: {
				latitude: 	-27.219969858168373,
				longitude: 	-49.643057999999996,
				icon: 			BASE_URL+'assets/img/marker_red.png',
				title: 			'ATHENEE',
				open: 			false,
				center: 		true
			},
			address: '<h4>ATHENEE</h4><p style="font-size:14px;color:#000">Rua Euclides da Cunha, 87, 3º andar<br>Ed. Almanara Medical Center<br>Rio do Sul - SC - Brasil</p>',
			styles: 'GRAYSCALE',
			origins: [
				['-27.219969858168373,', '-49.643057999999996'],
				['-27.219969858168373,', '-49.643057999999996']
			]
		};
