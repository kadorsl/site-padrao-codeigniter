...
// funções para redimensionamento
	...
	*/	
	private function resizeCrop() 
	{
		...
		// adiciona cor de fundo à nova imagem
		$this->preencheImagem();
		if(isset($_GET['marginTop']))
			imagecopyresampled( $this->img_temp, $this->img, -$this->posicao_crop[0], -$this->posicao_crop[1]+$_GET['marginTop'], 0, 0, $this->posicao_crop[2], $this->posicao_crop[3], $this->largura, $this->altura );
		else
...
// gera imagem de saída
	 ...
	 * @return void
	*/	
	public function grava( $destino='', $qualidade = 100, $bw = 0 ) 
	{
